  ...
  fs.readdir(dir, function(err, files) {
    ...
    files.forEach( function(file) {
      if(path.extname(file) == ".jpg") {
        var albumArtFile = path.join(dir, file);
        log.debug("jpg file: " + albumArtFile);
        self.checksumOfFile(albumArtFile, function(checksum) {
          ...
          fs.exists(checksumFile, function(exists) {
            if(!exists) {
              log.debug("new file: " + path.join(albumArtDir, checksumFileName));
