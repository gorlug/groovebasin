...
/**
 * Determines the sha1 checksum of a file.
 * 
 * @param file the file object
 * @param callback
 */
Player.prototype.checksumOfFile = function(file, callback) {
  ...
  fs.readFile(file, function(err, data) {
    ...
    callback(undefined, checksum(data));
  });
};
 ...
 */
Player.prototype.getAlbumCover = function(fullPath, callback) {
...
Player.prototype.addToLibrary = function(args, cb) {
  ...
  groove.open(fullPath, function(err, file) {
    ...
    self.getAlbumCover(fullPath, function(albumArt) {
      log.debug("albumArt: " + albumArt);
      newDbFile.albumArt = albumArt;
      var pend = new Pend();
      pend.go(function(cb) {
